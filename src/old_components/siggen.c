...
typedef struct bl_siggen_block_s {
    double theta_d;
    bl_pin_bit_t reset;
    bl_pin_float_t freq;
...
_Static_assert((sizeof(bl_siggen_block_t) < BL_BLOCK_DATA_MAX_SIZE), "block structure too large");


/* array of pin definitions - one copy in FLASH */
static bl_pin_def_t const bl_siggen_pins[] = {
    { "reset", BL_TYPE_BIT, BL_DIR_IN, offsetof(bl_siggen_block_t, reset)},
    { "freq", BL_TYPE_FLOAT, BL_DIR_IN, offsetof(bl_siggen_block_t, freq)},
    { "amplitude_f", BL_TYPE_FLOAT, BL_DIR_IN, offsetof(bl_siggen_block_t, amplitude_f)},
    { "offset_f", BL_TYPE_FLOAT, BL_DIR_IN, offsetof(bl_siggen_block_t, offset_f)},
    { "angle_f", BL_TYPE_FLOAT, BL_DIR_OUT, offsetof(bl_siggen_block_t, angle_f)},
    { "square_f", BL_TYPE_FLOAT, BL_DIR_OUT, offsetof(bl_siggen_block_t, square_f)},
    { "traingle_f", BL_TYPE_FLOAT, BL_DIR_OUT, offsetof(bl_siggen_block_t, triangle_f)},
    { "sin_f", BL_TYPE_FLOAT, BL_DIR_OUT, offsetof(bl_siggen_block_t, sin_f)},
    { "cos_f", BL_TYPE_FLOAT, BL_DIR_OUT, offsetof(bl_siggen_block_t, cos_f)},
    { "amplitude_i", BL_TYPE_S32, BL_DIR_IN, offsetof(bl_siggen_block_t, amplitude_i)},
    { "offset_i", BL_TYPE_S32, BL_DIR_IN, offsetof(bl_siggen_block_t, offset_i)},
    { "square_i", BL_TYPE_S32, BL_DIR_OUT, offsetof(bl_siggen_block_t, square_i)},
    { "traingle_i", BL_TYPE_S32, BL_DIR_OUT, offsetof(bl_siggen_block_t, triangle_i)},
    { "sin_i", BL_TYPE_S32, BL_DIR_OUT, offsetof(bl_siggen_block_t, sin_i)},
    { "cos_i", BL_TYPE_S32, BL_DIR_OUT, offsetof(bl_siggen_block_t, cos_i)}
};
...
static void bl_siggen_function(void *ptr, uint32_t period_ns)
{
    ...
    bl_siggen_block_t *p = (bl_siggen_block_t *)ptr;
